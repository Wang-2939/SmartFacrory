...
<body>
       ...
       <div class="row">
         ...
         <div class="col-md-10 a">
         	<div class="panel panel-default">
         		<div class="panel-heading">气报警</div>
         			...
         			<div class="panel-body">
						...
						<div class="row1">
							<div id="p1" style="height:230px" class="col-md-4"></div>
							<div id="p2" style="height:230px" class="col-md-4"></div>
							<div id="p3" style="height:230px" class="col-md-4"></div>
						</div>
	...
	<script type="text/javascript">
		function getAlarmCount(){
			$.post("./power/getGasAlarm",{insertTime:$("#selectDate").val()},function(data){
				var qiya=[];
				var qiliu=[];
				var gdwd=[];
				for(var i=0;i<data.length;i++){
					if(data[i].alarmType==1){
						qiya.push({value:data[i].alarmCount,name:data[i].alarmName});
					}
					if(data[i].alarmType==2){
						qiliu.push({value:data[i].alarmCount,name:data[i].alarmName});
					}
					if(data[i].alarmType==3){
						gdwd.push({value:data[i].alarmCount,name:data[i].alarmName});
					}
				}
		...
		function loadPage(totalPage){
			...
			$("#page").Page({
				...
				callBack:function(page){
					$.post("./power/getGasList",{insertTime:$("#selectDate").val(),pageNum:page,pageSize:5},function(data){
								showData(data);
							});
				}
			});
		...
		$(function(){
			...
			$("#selectDate").val(mydate);		
				getAlarmCount();
				$.post("./power/getGasList",{insertTime:$("#selectDate").val(),pageNum:1,pageSize:5},function(data){
					showData(data);
